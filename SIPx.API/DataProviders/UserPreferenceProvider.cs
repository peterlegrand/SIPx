...
namespace SIPx.API.DataProviders
{
    public class UserPreferenceProvider : IUserPreferenceProvider
    {
        ...
        public async Task<string> UserPreferenceUpdatePostCheck(UserPreferenceUpdateGet UserPreference)
        {
        ...
        public async Task<bool> UserPreferenceUpdatePost(UserPreferenceUpdateGet UserPreference)
        {
