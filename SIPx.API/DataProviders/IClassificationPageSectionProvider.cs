...
namespace SIPx.DataAccess
{
    public interface IClassificationPageSectionProvider
    {
        ...
        Task<ClassificationPageSectionDeleteGet> DeleteGet(string UserId, int ClassificationPageSectionId);
        ...
        bool UpdatePost(ClassificationPageSectionUpdateGet ClassificationPageSection);
    }
}