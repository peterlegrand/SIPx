...
{
    public class DevClassificationProvider : IClassificationProvider
    {
        private readonly ISqlDataAccess _sqlDataAccess;

        public DevClassificationProvider(ISqlDataAccess sqlDataAccess)
        {
        ...
        {
         List<ClassificationIndexGet> x = new List<ClassificationIndexGet>();
            x.Add(new ClassificationIndexGet
            {
                ClassificationId = 1,
                ClassificationLanguageId = 1
                ,
                Color = "ffffff"
                ,
                CreatedDate = DateTime.Now
                ,
                CreatorName = "John Cleese"
                ,
                CreatorId = 1
                ,
                DefaultPageId = 1
                ,
                DefaultPageName = "Crop"
                ,
                Description = "Crop"
                ,
                DropDownSequence = 1
