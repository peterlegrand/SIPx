...
namespace SIPx.DataAccess
{
    ...
    //    Task<List<PersonRelationTypeIndexGet>> PersonRelationTypeIndexGet(string UserId);
    //    Task<List<PersonRelationTypeLanguageIndexGet>> PersonRelationTypeLanguageIndexGet(string UserId, int PersonRelationTypeId);
