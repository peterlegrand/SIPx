...
(1, 1, 41, 'Köppen main group', 'Köppen main group', 'Köppen main group', 'Köppen main group', @User, @User, GETDATE(), GETDATE())
, (2, 2, 41, 'Köppen subgroup', 'Köppen subgroup', 'Köppen subgroup', 'Köppen subgroup', @User, @User, GETDATE(), GETDATE())
