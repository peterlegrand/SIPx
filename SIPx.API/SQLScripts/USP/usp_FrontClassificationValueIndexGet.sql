CREATE PROCEDURE [dbo].[usp_FrontClassificationValueIndexGet] (@CurrentUserId nvarchar(450), @ClassificationValueId int) 
AS 
BEGIN
...
SELECT Classifications.ClassificationID
	...
	, ISNULL(UserClassificationValueLanguage.Name,ISNULL(DefaultClassificationValueLanguage.Name,'No name for this classification value')) ClassificationValue
