CREATE PROCEDURE [dbo].[usp_ProcessTypeFlowConditionLanguage] (@UserId nvarchar(450), @ProcessTypeFlowConditionLanguageId int) 
AS 
...
WHERE ProcessTypeFlowConditionLanguages.ProcessTypeFlowConditionLanguageId = @ProcessTypeFlowConditionLanguageID
