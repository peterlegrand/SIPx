CREATE PROCEDURE [dbo].[usp_ProcessTypeStageFieldStatuses] (@UserId nvarchar(450)) 
AS 
...
JOIN UITermLanguages UIDescription
	ON UIDescription.UITermId = ProcessTypeStageFieldStatuses.NameTermID
JOIN UITermLanguages UIMenuName
	ON UIMEnuName.UITermId = ProcessTypeStageFieldStatuses.NameTermID
JOIN UITermLanguages UIMouseOver
	ON UIMouseOver.UITermId = ProcessTypeStageFieldStatuses.NameTermID
