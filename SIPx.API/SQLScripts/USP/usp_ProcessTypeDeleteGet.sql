CREATE PROCEDURE [dbo].[usp_ProcessTypeDeleteGet] (@UserId nvarchar(450), @ProcessTypeID int) 
AS 
...
JOIN ObjectTypeStatuses
	ON ObjectTypeStatuses.ObjectTypeStatusID = ProcessTypes.ObjectTypeStatusID
