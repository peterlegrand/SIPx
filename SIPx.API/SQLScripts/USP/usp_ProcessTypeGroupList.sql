CREATE PROCEDURE [dbo].[usp_ProcessTypeGroupList] (@UserId nvarchar(450)) 
AS 
...
ORDER BY ISNULL(UserProcessTypeGroupLanguage.Name,ISNULL(DefaultProcessTypeGroupLanguage.Name,'No name for this group'))
