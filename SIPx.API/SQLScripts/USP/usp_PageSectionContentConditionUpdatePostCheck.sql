CREATE PROCEDURE usp_PageSectionContentConditionUpdatePostCheck (
...
IF (SELECT COUNT(*) FROM PageSectionContentConditions WHERE PageSectionContentConditionId = @PageSectionContentConditionId) = 0 
BEGIN
...
IF  (SELECT COUNT(*) 
	...
	WHERE LanguageId = @LanguageID
		AND Name = @Name AND PageSectionContentConditionId <> @PageSectionContentConditionId ) >0
BEGIN
