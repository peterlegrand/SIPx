CREATE PROCEDURE [dbo].[usp_ClassificationUserIndexGet] (@UserId nvarchar(450), @ClassificationId int) 
AS 
...
SELECT ClassificationUsers.ClassificationUserID
	...
	, ClassificationUsers.CreatorID
	, ClassificationUsers.CreatedDate
	, Modifier.FirstName + ' ' + Modifier.LastName ModifierName
	, ClassificationUsers.ModifierID
