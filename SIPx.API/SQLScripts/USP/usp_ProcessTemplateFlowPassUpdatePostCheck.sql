CREATE PROCEDURE usp_ProcessTemplateFlowPassUpdatePostCheck (
...
IF (SELECT COUNT(*) FROM ProcessTemplateFlowPasses WHERE ProcessTemplateFlowPassId = @ProcessTemplateFlowPassId) = 0 
BEGIN
