CREATE PROCEDURE usp_ClassificationValueRoleUpdatePostCheck (
	@RoleId nvarchar(450)
...
IF (SELECT COUNT(*) FROM ClassificationValueRoles WHERE ClassificationValueRoleID = @ClassificationValueRoleId) = 0
BEGIN
