CREATE PROCEDURE usp_ProcessTypeFlowConditionUpdatePostCheck (
...
IF (SELECT COUNT(*) FROM ProcessTypeFlowConditions WHERE ProcessTypeFlowConditionId = @ProcessTypeFlowConditionId) = 0 
BEGIN
