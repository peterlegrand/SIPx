CREATE PROCEDURE [dbo].[usp_ProcessTypeFieldDeleteGet] (@UserId nvarchar(450), @ProcessTypeFieldId int) 
AS 
...
SELECT ProcessTypeFields.ProcessTypeFieldID
	...
	, ISNULL(UITypeNameCustom.Customization,UITypeName.Name) ProcessTypeFieldTypeName
