CREATE PROCEDURE [dbo].[usp_ProcessTypeStageFieldIndexGet] (@UserId nvarchar(450), @ProcessTypeStageId int) 
AS 
...
SELECT ProcessTypeStageFields.ProcessTypeStageFieldID
	...
	, ISNULL(UIStatusNameCustom.Customization,UIStatusName.Name) ProcessTypeStageFieldStatusName
