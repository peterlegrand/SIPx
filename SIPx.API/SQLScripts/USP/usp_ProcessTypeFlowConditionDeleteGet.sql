CREATE PROCEDURE [dbo].[usp_ProcessTypeFlowConditionDeleteGet] (@UserId nvarchar(450), @ProcessTypeFlowConditionId int) 
AS 
...
SELECT ProcessTypeFlowConditions.ProcessTypeFlowConditionID
	...
	, ISNULL(UITypeNameCustom.Customization,UITypeName.Name) ProcessTypeFlowConditionTypeName
