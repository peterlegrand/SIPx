CREATE PROCEDURE usp_PageSectionConditionIndexGet (@UserId nvarchar(450), @PageSectionId int) 
AS 
...
WHERE PageSectionConditions.PageSectionId = @PageSectionId
	AND UIPageSectionConditionTypeName.LanguageId = @LanguageID

ORDER BY ISNULL(UserPageSectionConditionLanguage.Name,ISNULL(DefaultPageSectionConditionLanguage.Name,'No name for this SectionCondition'))
