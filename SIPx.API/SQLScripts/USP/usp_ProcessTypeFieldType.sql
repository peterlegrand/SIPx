CREATE PROCEDURE [dbo].[usp_ProcessTypeFieldType] (@UserId nvarchar(450), @ProcessTypeFieldTypeId int) 
AS 
...
WHERE UIName.LanguageId = @LanguageID
	...
	AND ProcessTypeFieldTypes.ProcessTypeFieldTypeId = @ProcessTypeFieldTypeID