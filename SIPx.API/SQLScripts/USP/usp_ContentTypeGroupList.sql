CREATE PROCEDURE [dbo].[usp_ContentTypeGroupList] (@UserId nvarchar(450)) 
AS 
...
ORDER BY ISNULL(UserLanguage.Name,ISNULL(DefaultLanguage.Name,'No name for this content type group')) 
