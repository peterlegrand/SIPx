CREATE PROCEDURE usp_ClassificationUserUpdatePostCheck (
...
IF (SELECT COUNT(*) FROM ClassificationUsers WHERE ClassificationUserID = @ClassificationUserId) = 0
BEGIN
insert into @ErrorIdsTable values(34)
END
