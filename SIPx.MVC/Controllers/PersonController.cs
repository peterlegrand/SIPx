...
namespace SIPx.MVC.Controllers
{
    public class PersonController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var response = await client.GetProtectedAsync<List<PersonRelationEditGet>>($"{_baseUrl}api/Person",token);
        ...
        {
            var token = HttpContext.Session.GetString("Token");
            var response = await client.GetProtectedAsync<PersonRelationEditGet>($"{_baseUrl}api/Person/Edit/" + id, token);
