...
{
    public class ClassificationRelationUserController : Controller
    {
        ...
        public async Task<IActionResult> Index(int id)
        {
            ...
            var response = await client.GetProtectedAsync<List<ClassificationUserIndexGet>>($"{_baseUrl}api/ClassificationRelationUser/Index/" + id,token);
