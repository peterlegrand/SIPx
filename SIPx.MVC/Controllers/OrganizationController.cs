...
namespace SIPx.MVC.Controllers
{
    public class OrganizationController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var response = await client.GetProtectedAsync<List<OrganizationEditGet>>($"{_baseUrl}api/Organization",token);
        ...
        {
            var token = HttpContext.Session.GetString("Token");
            var response = await client.GetProtectedAsync<OrganizationEditGet>($"{_baseUrl}api/Organization/Edit/" + id, token);
