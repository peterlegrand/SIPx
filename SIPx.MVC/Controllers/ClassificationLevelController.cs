...
//PETER TODO put base url somewhere central
        ...
        public async Task<IActionResult> Index(int id)
        {
            ...
            var response = await client.GetProtectedAsync<List<ClassificationLevelViewGet>>($"{_baseUrl}api/ClassificationLevel/Index/" + id, token);
        ...
        {
            var token = HttpContext.Session.GetString("Token");
            var response = await client.GetProtectedAsync<ClassificationLevelEditGet>($"{_baseUrl}api/ClassificationLevel/Edit/" + id, token);
        ...
        {
            var token = HttpContext.Session.GetString("Token");
            var response = await client.GetProtectedAsync<List<ClassificationLevelViewGet>>($"{_baseUrl}api/ClassificationLevel/LanguageIndex" + id, token);
        ...
        {
            var token = HttpContext.Session.GetString("Token");
            var response = await client.GetProtectedAsync<ClassificationLevelEditGet>($"{_baseUrl}api/ClassificationLevel/LanguageEdit/" + id, token);
