...
namespace SIPx.MVC.Controllers
{
    public class ContentTypeClassificationController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var response = await client.GetProtectedAsync<List<ContentTypeClassificationEditGet>>($"{_baseUrl}api/ContentTypeClassification",token);
        ...
        {
            var token = HttpContext.Session.GetString("Token");
            var response = await client.GetProtectedAsync<ContentTypeClassificationEditGet>($"{_baseUrl}api/ContentTypeClassification/Edit/" + id, token);
